...
const Button = ({ disabled, type, children, to }) => {
  const base =
...
Button.propTypes = {
  ...
  disabled: PropTypes.bool,  // Prop for "disabled" (optional boolean)
  type: PropTypes.string,    // Prop for "type" (optional string)
  children: PropTypes.node.isRequired,  // Prop for children (can be anything that can be rendered)
  to: PropTypes.string.isRequired,      // Prop for "to" (assuming it's a URL or path)
};
